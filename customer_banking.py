...
def main():
    ...
    savings_maturity = int(input("Enter the number of months the savings account will accrue interest: "))
    ...
    # ADD YOUR CODE HERE
    print(f"Savings Account: Updated Balance: {updated_savings_balance:.2f}, Interest Earned: {interest_earned_savings:.2f}")
    ...
    cd_maturity = int(input("Enter the number of months the CD account will accrue interest: "))
    ...
    # ADD YOUR CODE HERE
    print(f"CD Account: Updated Balance: {updated_cd_balance:.2f}, Interest Earned: {interest_earned_cd:.2f}")
